...
int main(int argc, char *argv[])
{
    ...
    while (simple.loop(runTime))
    {
        ...
        #include "AdjD_Compliance.H"    // 伴随位移方程(of 柔度)
        #include "AdjT_Compliance.H"    // 伴随能量方程(of 柔度)
        #include "Adju_Compliance.H"    // 伴随NS方程(of 柔度)

        #include "AdjT_MeanT.H"//伴随能量方程(of 平均温度)
        #include "Adju_MeanT.H"//伴随NS方程(of 平均温度)

        #include "Adju_PowerDiss.H"//伴随能量方程(of 能量耗散)
