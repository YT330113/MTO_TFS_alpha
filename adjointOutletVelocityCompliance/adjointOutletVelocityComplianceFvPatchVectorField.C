...
#include "adjointOutletVelocityComplianceFvPatchVectorField.H"
#include "volFields.H"
...
Foam::adjointOutletVelocityComplianceFvPatchVectorField::
...
adjointOutletVelocityComplianceFvPatchVectorField
(
    const adjointOutletVelocityComplianceFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
adjointOutletVelocityComplianceFvPatchVectorField
(
    const adjointOutletVelocityComplianceFvPatchVectorField& pivpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
void Foam::adjointOutletVelocityComplianceFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::adjointOutletVelocityComplianceFvPatchVectorField::write(Ostream& os) const
{
